...
% Matlab Central Code from Yair M. Altman - adapted to newer Matlab version
% by R. Frey,
%
% Syntax:
...
%     % Matlab above 2011
%     try
%             jEditor = com.mathworks.mde.editor.MatlabEditorApplication.getInstance;
%     catch
        % Matlab 6
        try
...
if isempty(jEditor)
    fprintf(1,['EditorMacro could not retrieve the editor handle (not open?) ' ...
        '- Editor shortcuts and Macros not available.\n']);
%     myError('YMA:EditorMacro:noEditor','Cannot retrieve the Matlab editor handle - possibly no open editor');
end
try
